...
FROM "Applicant"
WHERE "Password".id = "Applicant"."passwordId";

UPDATE "Password"
SET "employerId" = "Employer".id
FROM "Employer"
WHERE "Password".id = "Employer"."passwordId";

UPDATE "Password"
SET "managerId" = "Manager".id
FROM "Manager"
WHERE "Password".id = "Manager"."passwordId";
